...
<div class="full-width row">
  <section class="container introduction">
    ...
    <div class="col-md-10 col-md-offset-1">
        <p>Hey. My name is David Endersby, I'm <?php echo (date(Y) - 1990);?> and I am a Web Designer/Developer. I have a Masters degree in Geological and Environmental Hazards and a Batchelors of Science degree in Geography. I'm also a Fellow of the British Geological Society.</p>
    </div>
  </section>
  <hr>
</div>
